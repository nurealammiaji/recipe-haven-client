        ...
        <footer className="text-white bg-gray-800">
            <div className="grid gap-5 p-2 md:grid-cols-3">
                ...
                <div className="text-center">
                    <h5 className="underline underline-offset-4"><FaLocationDot className="inline text-orange-500" /> Address</h5>
                ...
                <div className="text-center md:text-right">
                    <h5 className="underline underline-offset-4"><FaLink className="inline text-orange-500" /> Links</h5>
